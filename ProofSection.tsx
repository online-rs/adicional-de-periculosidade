    ...
    <section className="py-16 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          {/* Simplified: removed absolute positioning + transform rotation 
              that caused unnecessary paint complexity on mobile */}
          <div className="bg-gold-100 rounded-xl p-1.5">
