...
const Hero: React.FC<HeroProps> = ({ onCtaClick }) => {
  ...
  return (
    <div className="hero-bg">
      {/* Background is pure CSS gradient defined in index.html critical CSS.
          No external image request = instant LCP on mobile. */}
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 lg:py-32">
        <div className="lg:w-2/3">
          ...
          <h1 className="text-4xl lg:text-6xl font-serif font-bold text-white tracking-tight leading-tight mb-6">
